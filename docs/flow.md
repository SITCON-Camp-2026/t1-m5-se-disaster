...
- 這個使用者最想完成的事：快速知道自己現在應該不要出發、先確認來源、可以出發確認資訊，或只把資料當成線索。
...
如果資料來源是現場回報或志工更新，並且有明確時間與可核對地點，且沒有明顯不確定語句，行動者狀態可以顯示為「可以出發確認資訊」。
這只代表可以派一位現場幫手去核對公告、物資數量、集合點或報到規則，不代表正式派工、救災、送物資或安全保證。
...
- 是否可以從「可以出發確認資訊」進一步變成正式派工，必須由人判斷；目前系統不做這一步。
